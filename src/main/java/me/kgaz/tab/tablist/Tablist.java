...
import me.kgaz.tab.item.BlankTabItem;
 ...
 */
@ToString
public class Tablist extends SimpleTab {
    @Getter private final int columns;
    @Getter private final int rows;
    private final TableBox box;

    public Tablist(Tabbed tabbed, Player player, int columns, int minColumnWidth, int maxColumnWidth) {
